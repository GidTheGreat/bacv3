// Layout.jsx
import { Slider, Box, IconButton, Paper, Stack, Typography, Popover, Tooltip, Button, TextField, Divider } from "@mui/material";
      ...
      >
        {editingStake ? 
          <TextField
              ...
              variant="standard"
              error={isInvalid}
              helperText={isInvalid ? `Minimum: ${minNotional}` : undefined}
              sx={{
                  width: "60px",
                  backgroundColor: "",
                  "& input": {
        ...
        <Button variant="outlined" component="label" sx={{backgroundColor:"green"}}>Buy</Button>
        <Button variant="outlined" component="label" sx={{backgroundColor:"red"}}>Sell</Button>
      </Box>
